...
##  Transferable Skills from Creative Production Experience.
...
- **Deadline Management:** Consistently produced theatre and film art dept deliverables on time within tight deadlines with no room for delay - demonstrating ability to deliver software projects on schedule.
...
- **Milestone Tracking:** Broke down large projects into manageable phases (concept, design, build, install, Strike), mirroring agile sprint planning and software development lifecycle stages.
- **Quality Assurance:** Maintained high production standards under time pressure ensuring finished work met artistic plained requirements.
...
- **Scenic Artist Precision:** Executed detailed paintwork requiring extreme accuracy and consistency - attention to detail is applicable to writing clean, precise code and catching bugs.
...
- **Continuity Management:** Maintained visual consistency across scenes and performances tracking production design continutity details over production runs.
...
- **Rapid Skill Acquisition:** Continuously learned new techniques, materials, and technologies in evolving theatre industry paralleling the need for ongoing learning in fast-changing tech sector.
- **Technology Adoption:** Integrated new tools and software such as CAD programs and sketch up program into traditional scenic design workflow.
...
- **Continuous Improvement:** Actively sought feedback and constructive criticism refined techniques improving craft over time demonstrating growth mindset.
...
- Object-Oriented Programming, Software design and Data Structures (Java).
...
- **Full-Stack Capability:** Understanding across entire web development stack from database design through backend logic to responsive frontend implementation.
...
- **Fast Learner:** Successfully transitioned from arts to technical field learning new skills in programming languages, frameworks, and development tools.
...
### Unique Perspective
- **User Empathy:** Understanding of end-user experience.
- **Design Sensibility:** Appreciation for aesthetics and usability in interface design.
- **Attention to Detail:** Meticulous approach to work and attention to detail ensuring quality and catching errors.
 ...
 **[naughtonmarykerin@gmail.com]** - Feel free to reach out about opportunities 
